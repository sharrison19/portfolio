    ...
    <div className="home-container">
      ...
      <div className="home-text-container">
        ...
        <p className="home-introduction">
          ...
          passionate web developer with a drive for building modern and
          user-friendly web applications. I enjoy turning creative ideas into
        ...
        <p className="home-create typewriter">
